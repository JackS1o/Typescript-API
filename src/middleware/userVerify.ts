...
export default class MiddUser {
  public userNameCheck = async (req: Request, res: Response, next: NextFunction) => {
  ...
  public classeCheck = async (req: Request, res: Response, next: NextFunction) => {
  ...
  public levelCheck = async (req: Request, res: Response, next: NextFunction) => {
  ...
  public passwordCheck = async (req: Request, res: Response, next: NextFunction) => {
